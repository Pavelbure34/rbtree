...
template<class T>
void test_rbt_insert(rbt<T> &tree, T* a, T* b){
  tree.insert(a);           //testing insert
  // tree.insert(b);
...
int main(int argc, char const *argv[]) {
  ...
  // LOG2("rbt copy constructor on empty tree:");
  ...
  // LOG2("rbt copy assignment operator with emptyTree:");
  ...
  // LOG1("passed");
  // LOG1("rbt empty:passed"); //reaching here, empty works.

  // LOG2("rbt insert:");
  test_rbt_insert(it, new int(10), new int(15));
  // test_rbt_insert(dt, new double(10.0), new double(15.0));
  // test_rbt_insert(ft, new float(10.0f), new float(15.0f));
  // test_rbt_insert(ct, new char('a'), new char('b'));
  // test_rbt_insert(st, new string("NO"), new string("Hello"));
  // LOG1("passed");

  // LOG2("rbt copy constructor with non-emptyTree:");
  // rbt<int> it2(it);          
  // rbt<double> dt2(dt);
  // rbt<float> ft2(ft);
  // rbt<char> ct2(ct);
